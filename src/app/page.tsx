    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="lg:grid lg:grid-cols-2 lg:gap-x-8">
          ...
          {/* Image Gallery (Simplified for 1 image per variant) */}
      ...
      {/* Interviewer Notes Section - Hidden on production, useful for test context */}
      {/* <div className="max-w-7xl mx-auto mt-8 p-6 bg-yellow-50 border border-yellow-200 rounded-xl">
        <h3 className="text-lg font-bold text-yellow-800 mb-2">Interviewer Context</h3>
        <p className="text-sm text-yellow-700 mb-4">
          This UI is driven by mock data. The candidate should be able to deduce the following relationships for the backend implementation:
        </p>
        <ul className="list-disc pl-5 text-sm text-yellow-700 space-y-1">
          <li><strong>Product</strong> (1) → (N) <strong>Variants</strong></li>
          <li><strong>Variant</strong> (1) → (N) <strong>Specifications</strong></li>
        </ul>
      </div> */}
    </div>
  );
